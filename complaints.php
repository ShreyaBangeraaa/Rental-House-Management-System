...
<body class="realestate_version">
	...
	<div class="wrapperr" style="margin-top:30px;">
	<div class="feed" style="margin-top:-320px;color:black;margin-right:-130px;">FEEDBACK</div>
		<form action="" method="post" class="form">
		 	

			<input type="text" class="name" name="name" placeholder="Enter your name" required="" style="color:black;margin-top:150px;" >
			<br>
			<input type="email" class="email" name="email" placeholder="Enter your Email" required="" style="color:black;margin-bottom:-90px;">
			<br>
			<br>
			<textarea name="message" cols="30" rows="4" class="message"  required="" placeholder="Comment/Feedback"style="color:black;margin-bottom:50px;"></textarea>
			<br>

			<button type="submit" class="btn" name="post_comment" style="margin-top:-40px;">Post Comment</button>
		</form>
	</div>
