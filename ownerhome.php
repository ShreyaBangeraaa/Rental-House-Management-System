            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a class="active" href="ownerhome.php">Home</a></li>
			...
			<div class="row">
				<div class="col-md-6">
                    <div class="post-media wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
                        <img src="images/house12.jpg" alt="" class="img-responsive" style="width:730px;height:400px;">                        

                    </div><!-- end media -->
                </div>
				<div class="col-md-6">
					<div class="message-box right-ab">
                        <h4>Awards Winning Rental Company</h4>
                        <h2>Welcome to HomeKey</h2>
                        <p>Home key is the new home rental platform thet makes it easier to find your new home without paying any brokerage.</p>
						<p>The super app for Rental Management</p>
						<p>Get on the home with our Affordable fare mode! Whenever,wherever you need to buy for rent,we are always there for you with fair fares.</p>
						<center><img src="images/2020.png" alt="" width="330px" height="350px" style="margin-top:-30px;"></center>  
