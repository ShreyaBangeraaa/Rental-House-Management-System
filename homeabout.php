            ...
            <div class="container-fluid">
                ...
                <div id="nav" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="active" href="homeabout.php"><i class="fa fa-user" aria-hidden="true"></i>
                         About us </a></li>
				...
				<div class="top-feature owl-carousel owl-theme">
					<div class="item">
						<div class="single-feature">
							...
							<h4><a href="#">Easily Connect With Community Residents</a></h4>
							<p>Residents constantly updated with latest community information. </p>
							<p>Make the best neighbourwood facilities</p>

						</div> 
					</div>
					<div class="item">
						<div class="single-feature">
							<div class="icon"><img src="images/b.png" style="height:140px;margin-top:-20px;" class="img-responsive" alt=""></div>
							<h4><a href="#">Online Tenant Payments</a></h4>
							<p>User can pay rent through online.</p>
							<p>Owner can easily aceess rental payment details</p>
						</div> 
					</div>
					<div class="item">
						<div class="single-feature">
							<div class="icon"><img src="images/a.png" style="height:100px;" class="img-responsive" alt=""></div>
							<h4><a href="#">Manage Users/Owners</a></h4>
							<p>Add,Update,Approve/Deactivate users and owners.</p>
							<p>HomeKey strickly prohibites fake acounts and illegal activities</p>
						</div> 
					</div>
					<div class="item">
						<div class="single-feature">
							<div class="icon"><img src="uploads/icon-04.png" class="img-responsive" alt=""></div>
							<h4><a href="#">Helpdesk Trackers </a></h4>
							<p>HomeKey aceepting valuable feedback and complaints<p>
							<p>Track progress reports of complaints/queries.</p>
					</div>
				</div>
			</div>
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-left">
                    <p class="footer-company-name">All Rights Reserved. &copy; 2018 <a href="#">HomeKeyRentals</a> Design By : <a href="https://html.design/">HomeKey Management</a></p>
                </div>
