            ...
            <div class="row">
                <div class="col-md-6 wow slideInLeft hidden-xs hidden-sm">
					...
					<a href="index.php"><i class="fa fa-close" style="float:right;margin-right:-20px;margin-top:-40px;font-size:25px;color:black;"></i></a>
                        <h3><i class="fa fa-envelope-o grd1 global-radius"></i> OWNER &nbsp;LOGIN</h3>
	...
	function toggle(){
		if(state){
			...
			state=true;
							...
							<div>
					<a href="forgot1.php">Forget Password?</a><p> 
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
									...
									Don't have an account? <a href="owner.php"> &nbsp;&nbsp;<b>Register...</b></a><br><br>
</div>
