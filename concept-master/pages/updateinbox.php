        ...
        <!-- ============================================================== -->
         <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top" style="height:20px;">
                <a class="navbar-brand" href="../index.html"><img src="images/2021.png" style="width:160px;height:130px;margin-top:10px;margin-left:20px;" alt="image"></a>
        ...
        <div class="nav-left-sidebar sidebar-dark">
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light">
					...
					<a  href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><class="colorlib-active"><a href="index.php"><class style="margin-left:50px;"><i class="fa fa-fw fa-user-circle"></i>View Users</a><br><br><br>
				<a  href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2">	<a href="manage.php"><class style="margin-left:50px;"><i class="fa fa-fw fa-user-circle"></i>Manage Owners</a><br><br><br>
						 <li class="nav-item" >
                                <a  href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><a href="updateinbox.php"><class style="margin-left:50px;"><i class="fa fa-fw fa-bell"></i>Update Notification</a>
                               <!-- <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/updateinbox.php">Inbox </a>
                                        </li>
													</ul>
													</div>
													</li>
