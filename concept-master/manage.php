...
<head>
    ...
    <link rel="stylesheet" href="assets/libs/css/adminstyle.css">
...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top" style="height:20px;">
                <a class="navbar-brand" href="index.php"><img src="assets/images/2020.png" style="width:170px;height:170px;margin-top:31px;margin-left:5px;" alt="image"></a>
        ...
        <div class="nav-left-sidebar sidebar-dark">
            <div class="menu-list">
				...
				<br><br>	<a  href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><class="colorlib-active"><a href="index.php"><class style="margin-left:50px;font-size:17px;"><i class="fa fa-fw fa-user-circle"></i>View Users</a><br><br><br>
				<a  href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2">	<a href="manage.php"><class style="margin-left:50px;font-size:17px;"><i class="fa fa-fw fa-user-circle"></i>View Owners</a><br><br><br>
					
                               
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-2" aria-controls="submenu-1-2"><class style="margin-left:40px;font-size:17px;"><i class="fa fa-fw fa-bell"></i>Feedback</a>
                              <div id="submenu-1-2" class="collapse submenu" style="">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                      <a class="nav-link" href="ownerupdate.php">Owners Feedback</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="update.php">Users Feedback</a>
                                                    </li>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">View Owners </h2>
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card" style="background-color:#0e0c28;">
								<?php {
										include 'config.php';
									...
									?>
                                    <div class="card-body">
                                        <h5 class="text-muted"><label style="color:white;">Total Owners</h5></label>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1" style="color:white;"><?php echo $rowcount;?></h1>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
								...
								<?php {
									...
									?>
                                    <div class="card-body">
                                        <h5 class="text-muted"><label style="color:white;">House Sold</h5></label>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1" style="color:white;"><?php echo $rowcount;?></h1>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-1">
                                                        <th class="border-1">SI No</th>
                                                        <th class="border-1">Name</th>
                                                        <th class="border-1">Phone number</th>
                                                        <th class="border-1">Email</th>
                                                        <th class="border-1">Address</th>
                                                        
                                                    </tr>
                                                </thead>
                                                <tbody table border="4">
												 
								<?php
								include 'config.php';
								$sql= "select owner.username,owner.phone,owner.email,owner.addres,owner.id from owner inner join house on owner.email=house.Owner group by house.Owner";
