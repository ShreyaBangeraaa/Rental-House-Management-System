                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card" style="background-color:#0e0c28;color:white;">
								<?php {
										include 'config.php';
									...
									?>
                                    <div class="card-body">
                                        <h5 class="text-muted" ><label style="color:white;">Total Users</h5></label>
                                                ...
                                                <thead class="bg-light">
                                                    <tr class="border-1">
                                                        ...
                                                        <th class="border-1">Email</th>
													     <th class="border-1">Adhar Number</th>
