			...
			<div class="card" style="width:85em;">
                                    <div class="card-body" >
                                       <div class="metric-value d-inline-block" >
                                            <h1 class="mb-1" style="font-size:15px;"><?php echo $name;?></h1>
                                        
                                            <h1 class="mb-1" style="font-size:15px;"><?php echo $email;?></h1>
                                       
                                            <h1 class="mb-1" style="font-size:15px;"><?php echo $comment;?></h1>
											<h1 class="mb-1" style="font-size:15px;"><?php echo $rate;?><i class="fa fa-star" style="color:orange;font-size:17px;"></i></h1>
