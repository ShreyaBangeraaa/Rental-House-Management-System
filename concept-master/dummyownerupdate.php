    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="nav-left-sidebar sidebar-dark">
            <div class="menu-list">
				...
				<a  href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2">	<a href="manage.php"><class style="margin-left:50px;font-size:17px;"><i class="fa fa-fw fa-user-circle"></i>Manage Owners</a><br><br><br>
			...
			<div class="card" style="width:85em;">
                                    <div class="card-body" >
                                       <div class="metric-value d-inline-block" >
                                            <h1 class="mb-1" style="font-size:15px;">Name:<?php echo $name;?></h1>
                                        
                                            <h1 class="mb-1" style="font-size:15px;">Email:<?php echo $email;?></h1>
                                       
                                            <h1 class="mb-1" style="font-size:15px;">Comment:<?php echo $comment;?></h1>
