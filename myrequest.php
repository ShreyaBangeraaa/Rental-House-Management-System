...
<header class="header header_style_01">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="userabout.php">About us</a></li>
						 ...
						 <li><a class="active" href="myrequest.php">My Request</a></li>								
	...
	<div class="container">
		...
		<?php
								...
								include 'config.php';
								$sql = "select house.id, booking.id, booking.useremail,booking.owneremail from booking left join house on house.id=booking.houseid where house.id IS NULL and booking.useremail='".$_SESSION['rentuser']."'";
								...
								include 'config.php';
								$sql1 = "select house.id,house.Owner,house.Totalroom,house.Rent,house.Advance,house.Parking,house.Type,house.Square,house.Address,house.Nearby,house.Agreement,house.rules,house.image,booking.id, booking.status from house inner join booking on house.id=booking.houseid where booking.useremail='".$_SESSION['rentuser']."'";
                      ...
                      <a href="uploads/<?php echo $image; ?>" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
							...
							<div class="item-body">
								...
								<div class="info">
									...
									<span><center><p style="color:darkblue;font-size:20px;font-weight:100;padding:10px;">Your Request has been <?php echo $status; ?></span></p>
						...
						<div class="item-foot">
							<div class="pull-left">
								...
								<input type="text" name="rid[]" value="<?php echo $rid; ?>" hidden="true">
							...
							<button type="submit" name="delete" class="btn" onClick='return confirmSubmit()'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Delete</button></b>
							</div>
							</form>
			...
			<?php
					 ...
					 echo "<script> alert('No Request Sent..'); </script>";
												...
												if(isset($_POST['delete']))
								{
									...
									$sql2 = "delete from booking where id='".$rid1."'";
									mysqli_query($con,$sql2) or die(mysqli_error($con));
								   echo "<script> alert('Request deleted'); </script>";
								   echo "<script> location.href='myrequest.php'; </script>";
								}
								?>
		</div><!-- end row -->
...
{
var agree=confirm("Are you sure you to delete?");
if (agree)
 return true ;
else
 return false ;
