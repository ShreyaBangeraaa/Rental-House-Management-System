...
<div class="login">
    ...
    <form method="post">
        ...
        <button type="submit" class="btn btn-primary btn-block btn-large" name="reset">RESET</button><br>
		<a href="ownerlogin.php"><button type="submit" class="btn btn-primary btn-block btn-large" name="back" onclick="ownerlogin.php">BACK</button></a>
...
error_reporting(1);
	...
	if($count>0)
	{
		...
		if ($question==$squestion && $answer==$sanswer)
		{
		...
		{	
			echo "<script>
				alert('Your Secret Question Does Not Match.');
			</script>";
		}
	}
	else
